...
exports.getAll = (req, res) => {
  // 1- Buscar todas as entradas de Usuários // ok
  // 2- Lidar com uma resposta bem sucedida da busca // ok
  // 2.1- Mandar alguma resposta formatada com status 204 caso não exista nenhum usuário cadastrado
  // 2.2- Responder com status 200 e os usuários // ok
    ...
    .then(existingUser => {
      if (existingUser.length === 0) {
        return res.status(204).json({
          errors: ['Não há usuarios cadastrados']
        })
      } else {
